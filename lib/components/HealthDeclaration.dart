...
class TermsAggreeement extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: [Terms(), SizedBox(height: 20)],
      ),
    );
  }
}

class UserTermsAggreeement extends StatelessWidget {
  const UserTermsAggreeement({Key key}) : super(key: key);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FormBuilderSwitch(
              label: Text('STOMACH ACHE / DIARRHEA (SAKIT SA TYAN / PAGTATAE)'),
