...
class MainHealthDeclarationStepper extends StatefulWidget {
  ...
  @override
  _MainHealthDeclarationStepperState createState() => _MainHealthDeclarationStepperState();
}

class _MainHealthDeclarationStepperState extends State<MainHealthDeclarationStepper> {
  int _currentStep = 0;
